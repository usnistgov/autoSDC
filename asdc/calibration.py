...
def parse_calibration_sheet(df, name=None, verbose=False):
    ...
    for key, idx in solutions:
        ...
        row.update({col: np.array(d.values)[:,idx] for idx, col in enumerate(d.columns)})
...
def load_calibration_data(calibration_file='../data/calibration/Ni-Co-calibration-curves-2019-04-23.xlsx'):
