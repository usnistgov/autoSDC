...
def acquire_cv_data(pstat, pos, idx, poll_interval=8):
    ...
    status, params = pstat.multi_cyclic_voltammetry(
        initial_potential=0.0, vertex_potential_1=-0.25, vertex_potential_2=0.65, final_potential=0.0, scan_rate=0.1,
        cell_to_use='EXTERNAL', e_filter='1Hz', i_filter='1Hz', cycles=3
    )
