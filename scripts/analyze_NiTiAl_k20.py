...
def extract_cv_features(data, start=1120):
    ...
    log_I, m, lm, cv_features = analyze.model_polarization_curve(V, log_I, bg_order=7, lm_method='huber', smooth=True)
...
def analyze_NiTiAl():
    ...
    composition = model_composition(k20, invert_x=invert_x, convert_to_decimal=convert_to_decimal)
    ...
    for idx, datafile in enumerate(datafiles):
        ...
        res = {'current': d['current'], 'potential': d['potential'], 'error_codes': d['error_codes']}
